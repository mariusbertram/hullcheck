...
func TestSummarizeSyft(t *testing.T) {
	...
	if summary.ByType["apk"] != 2 || summary.ByType["npm"] != 1 {
...
func TestSummarizeGrype(t *testing.T) {
	...
	content := map[string]interface{}{
		"matches": []map[string]interface{}{
			{"vulnerability": map[string]interface{}{"severity": "Critical"}},
			{"vulnerability": map[string]interface{}{"severity": "High"}},
			{"vulnerability": map[string]interface{}{"severity": "High"}},
		},
	}
	data, _ := json.Marshal(content)
...
func TestSummarizeGrant(t *testing.T) {
	...
	content := []licensedPackage{
		{Name: "pkg-a", Version: "1.0", Type: "apk", Licenses: []string{"MIT"}},
		{Name: "pkg-b", Version: "2.0", Type: "apk", Licenses: []string{"MIT"}},
		{Name: "pkg-c", Version: "3.0", Type: "apk", Licenses: []string{"Apache-2.0"}},
		{Name: "pkg-d", Version: "4.0", Type: "apk", Licenses: nil},
	}
	data, _ := json.Marshal(content)
